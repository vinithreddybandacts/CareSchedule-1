...
public partial class CareScheduleContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=LTIN719622\\SQLEXPRESS;Initial Catalog=CareSchedule;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True;Integrated Security=True");
        }
    }
